...
typedef void (*seret_audio_play_cb)(void *data, const void *samples, unsigned count, int64_t pts);
typedef void (*seret_audio_pause_cb)(void *data, int64_t pts);
typedef void (*seret_audio_resume_cb)(void *data, int64_t pts);
typedef void (*seret_audio_flush_cb)(void *data, int64_t pts);
typedef void (*seret_audio_drain_cb)(void *data);
