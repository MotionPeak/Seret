...
///
/// Nested under `SwiftDataSuite` since `LocalWatchProviderTests` made this package's second
/// SwiftData suite — two live in-memory `ModelContainer`s intermittently crash the runner.
